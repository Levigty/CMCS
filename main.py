...
if __name__ == '__main__':
    ...
    processors['pretrain_skeleton'] = import_class('processor.pretrain_skeleton.Skeleton_Processor')
    processors['pretrain_skeleton_3views'] = import_class('processor.pretrain_skeleton_3views.Skeleton_3views_Processor')

    processors['linear_evaluation'] = import_class('processor.linear_evaluation.LE_Processor')
    processors['linear_evaluation_3views'] = import_class('processor.linear_evaluation_3views.LE_Processor')
    
    processors['semi_evaluation'] = import_class('processor.semi_evaluation.SE_Processor')
