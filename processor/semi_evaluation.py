...
class SE_Processor(Processor):
    """
        Processor for Semi-supervised Evaluation.
    """
    ...
    def train(self, epoch):
        ...
        for data, label in loader:
            ...
            if self.arg.stream == 'joint' or self.arg.stream == 'all':
                pass
            ...
            loss.backward()
            torch.nn.utils.clip_grad_norm_(self.model.parameters(), 2, norm_type=2)
            self.optimizer.step()
