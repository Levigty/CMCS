...
class CACA_3views(nn.Module):
    ...
    def __init__(self, base_encoder=None, pretrain=True, feature_dim=128, projection_hidden_size=1024,
        ...
        self.online_backbone_joint = base_encoder(input_size=150, hidden_size=feature_dim // 2, num_layers=3)
        self.online_backbone_motion = base_encoder(input_size=150, hidden_size=feature_dim // 2, num_layers=3)
        self.online_backbone_bone = base_encoder(input_size=150, hidden_size=feature_dim // 2, num_layers=3)
